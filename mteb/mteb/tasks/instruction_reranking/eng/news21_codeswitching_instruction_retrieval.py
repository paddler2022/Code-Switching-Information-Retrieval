...
CS_MTEB_REPO = "UTokyo-Yokoya-Lab/news21-instructions-mteb_CS-MTEB"
...
class News21InstructionRetrievalCodeSwitching(AbsTaskRetrieval):
    metadata = TaskMetadata(
        ...
        description="News21 Instruction Retrieval Code-Switching variant.",
...
""",
    ...
    def __init__(self, language: str = "zh", **kwargs):
        ...
        self.metadata.name = f"News21InstructionRetrievalCodeSwitching_{language}"
