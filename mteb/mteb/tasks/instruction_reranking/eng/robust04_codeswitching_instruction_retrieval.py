...
CS_MTEB_REPO = "UTokyo-Yokoya-Lab/robust04-instructions-mteb_CS-MTEB"
...
class Robust04InstructionRetrievalCodeSwitching(AbsTaskRetrieval):
    metadata = TaskMetadata(
        ...
        description="Robust04 Instruction Retrieval Code-Switching variant.",
...
""",
    ...
    def __init__(self, language: str = "zh", **kwargs):
        ...
        self.metadata.name = f"Robust04InstructionRetrievalCodeSwitching_{language}"
    ...
    def task_specific_scores(self, scores, qrels, results, hf_split, hf_subset):
        qrel_diff_ds = load_dataset(CS_MTEB_REPO, "qrel_diff", split="qrel_diff")
