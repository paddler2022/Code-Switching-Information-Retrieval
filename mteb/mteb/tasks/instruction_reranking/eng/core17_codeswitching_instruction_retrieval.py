...
CS_MTEB_REPO = "UTokyo-Yokoya-Lab/core17-instructions-mteb_CS-MTEB"
...
class Core17InstructionRetrievalCodeSwitching(AbsTaskRetrieval):
    metadata = TaskMetadata(
        ...
        description="Core17 Instruction Retrieval Code-Switching variant.",
...
""",
    ...
    def __init__(self, language: str = "zh", **kwargs):
        ...
        self.metadata.name = f"Core17InstructionRetrievalCodeSwitching_{language}"
