...
CSR_L_REPO = "UTokyo-Yokoya-Lab/news21-instructions-mteb-CSR-L"
SUPPORTED_LANGUAGES = ["zh", "ja"]


class News21InstructionRetrievalCSRL(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="News21InstructionRetrievalCSRL",
        description="News21 Instruction Retrieval CSR-L variant (Chinese/Japanese code-switching).",
...
""",
    ...
    def __init__(self, language: str = "zh", **kwargs):
        ...
        self.metadata.name = f"News21InstructionRetrievalCSRL_{language}"
