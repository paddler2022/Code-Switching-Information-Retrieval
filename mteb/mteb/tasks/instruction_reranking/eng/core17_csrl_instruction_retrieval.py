...
CSR_L_REPO = "UTokyo-Yokoya-Lab/core17-instructions-mteb-CSR-L"
SUPPORTED_LANGUAGES = ["zh", "ja"]


class Core17InstructionRetrievalCSRL(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="Core17InstructionRetrievalCSRL",
        description="Core17 Instruction Retrieval CSR-L variant (Chinese/Japanese code-switching).",
...
""",
    ...
    def __init__(self, language: str = "zh", **kwargs):
        ...
        self.metadata.name = f"Core17InstructionRetrievalCSRL_{language}"
