...
CSR_L_REPO = "UTokyo-Yokoya-Lab/trec-covid-CSR-L"
SUPPORTED_LANGUAGES = ["zh", "ja"]


class TRECCOVIDCSRL(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="TRECCOVIDCSRL",
        description="TREC-COVID CSR-L variant (Chinese/Japanese code-switching).",
...
""",
    ...
    def __init__(self, language: str = "zh", **kwargs):
        ...
        self.metadata.name = f"TRECCOVIDCSRL_{language}"
    ...
    def load_data(self, **kwargs):
        ...
        # trec-covid-CSR-L uses JSONL format with config names in README
