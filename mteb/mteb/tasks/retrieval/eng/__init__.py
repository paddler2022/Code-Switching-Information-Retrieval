...
# from .hateful_memes_i2t_retrieval import HatefulMemesI2TRetrieval  # requires polars
# from .hateful_memes_t2i_retrieval import HatefulMemesT2IRetrieval  # requires polars
...
__all__ = [
    ...
    # "HatefulMemesI2TRetrieval",  # requires polars
    # "HatefulMemesT2IRetrieval",  # requires polars
    "HellaSwag",
    "HotpotQA",
    "HotpotQAHardNegatives",
    "HotpotQAHardNegativesV2",
